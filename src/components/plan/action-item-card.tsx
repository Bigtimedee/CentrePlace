...
export function ActionItemCard({ item, expanded = false, onToggle }: ActionItemCardProps) {
  ...
  return (
    <div
      className={`rounded-xl border border-slate-800 bg-slate-900 border-l-4 ${uc.border} transition-colors hover:border-slate-700`}
    >
      {/* Header row */}
      <button
        type="button"
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex flex-wrap items-center gap-2 mb-1">
            ...
            <span className="inline-flex items-center rounded-md bg-slate-800 px-2 py-0.5 text-xs text-slate-400 border border-slate-700">
