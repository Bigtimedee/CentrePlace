                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <span className={`text-sm font-semibold font-mono flex-shrink-0 ${
                      metric.isSavings ? "text-emerald-400" : "text-slate-300"
                    }`}>
            ...
            <table className="w-full text-sm">
              ...
              <tfoot>
                <tr className="border-t-2 border-slate-700">
                  <td className="px-6 py-3 text-xs font-semibold text-slate-400" colSpan={2}>
                    Total
                  </td>
                  <td className="px-4 py-3 text-right font-mono text-xs font-bold text-slate-300">
                    {formatPct(beneficiaries.reduce((s, b) => s + b.inheritancePct, 0))}
                  </td>
                  <td className="px-6 py-3 text-right font-mono font-bold text-indigo-400">
