      ...
      <table className="w-full text-xs">
        <thead>
          <tr className="border-b border-slate-800">
            ...
            <th className="text-right text-slate-500 font-medium pb-2 pr-3">Carry %</th>
            <th className="text-right text-slate-500 font-medium pb-2 pr-3">TVPI</th>
            <th className="text-right text-slate-500 font-medium pb-2 pr-3">Gross Carry</th>
            <th className="text-right text-slate-500 font-medium pb-2 pr-3">Haircut</th>
            <th className="text-right text-slate-500 font-medium pb-2 pr-3">Net Carry</th>
            <th className="text-right text-slate-500 font-medium pb-2 pr-3">Realization</th>
            <th className="text-right text-slate-500 font-medium pb-2 pr-3">Est. Tax</th>
            <th className="text-right text-slate-500 font-medium pb-2 pr-3">Net After Tax</th>
            <th className="text-right text-slate-500 font-medium pb-2">Pipeline</th>
          </tr>
        </thead>
        <tbody>
          {sorted.map((f, i) => (
            <tr key={f.fundName} className={i % 2 === 0 ? "bg-slate-800/20" : ""}>
              ...
              <td className="py-1.5 pr-3 text-right text-slate-500">{formatPct(f.haircutPct)}</td>
